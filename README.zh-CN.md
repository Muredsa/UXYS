<p align="center">
  <img src="assets/uxys-banner-zh-CN.svg" alt="UXYS — User eXperience Yield System" width="100%" />
</p>

<p align="center">
  <strong>面向 AI Agent 的意图优先 UX 分析方法。</strong><br/>
  将界面建模为由短而充分的用户路径组成的网络，而不是输出通用 UX 检查清单。
</p>
